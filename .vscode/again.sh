...
cd test
sed -i "s/SIDE_2_IP/${CONTAINER_IP}/g" ./soft_case.yaml
sed -i "s/SIDE_1_IP/${LINK_DEV_IP}/g" ./soft_case.yaml
sed -i "s/SIDE_1_PORT/${GRPC_PORT}/g" ./soft_case.yaml
sed -i "s/SIDE_2_PORT/${GRPC_PORT}/g" ./soft_case.yaml
...
sleep 2
python3 ./sanity_manager.py ../test/soft_case.yaml
